...
namespace OptimizeName
{
  ...
  class Function : public AbstFunction
  {
	...
	//AbstFunction(type, id);
      ...
      int SwapVariable_r2(int xpivod, int ix, int, Function &Bi, map<int, map<int, int> > &, bool &Flag);
      int getXpivodCol(vector<Function> &B);
      int getXpivodCol_r2(vector<Function> &B, map<int, map<int, int> > &);
      int getXpivodRow(int &xpivod, vector<Function> &B);
      int getXpivodRow_r2(int &xpivod, vector<Function> &B, map<int, map<int, int> >&);
